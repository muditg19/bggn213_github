...
Didn't added the below code as render gave error 
'processing file: class-10.rmarkdown
  |.....................................    |  90% [update.packages(ask=FALSE)]Error in startup(port = port, ...) : 
...
Quitting from lines 263-268 [update.packages(ask=FALSE)] (class-10.rmarkdown)
Execution halted' from code'
